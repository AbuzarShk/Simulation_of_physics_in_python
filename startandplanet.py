...
class Startandplanet():
    def __init__(self,massofstar = 2.0 , massofplanet = 1):
        self.massofstar = massofstar
        self.massofplanet = massofstar
        ...
        star = sphere( pos=vector(0,0,0), radius=0.2, color=color.yellow,
               mass = self.massofstar*1000, momentum=vector(0,0,0), make_trail=True )
        planet = sphere( pos=vector(1,0,0), radius=0.05, color=color.blue,
               mass = self.massofplanet, momentum=vector(0,30,0), make_trail=True )
